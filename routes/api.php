...
Route::middleware('auth:sanctum')->post('/advertisements/my-advertisements/edit', [AdvertisementsController::class, 'updateAdvertisement']);
...
Route::middleware('auth:sanctum')->get('/settings/about', [SettingsController::class, 'about']);
